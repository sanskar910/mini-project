const faculty = [
  { 
    ...
    profile: "Dr. Smith has 15+ years of experience in computer science research with expertise in AI and machine learning. Published 50+ research papers.",
    office: "CS-301",
  ...
  { 
    ...
    profile: "Research focus on quantum physics and theoretical mechanics. Former NASA researcher with 8 years of academic experience.",
    office: "PHY-102",
  ...
  { 
    ...
    profile: "Leading researcher in organic synthesis with 20+ years experience. Department head and published author of 3 textbooks.",
    office: "CHEM-401",
...
const subjects = [
  ...
  { id: 6, name: "Linear Algebra", code: "MATH201", description: "Vector spaces and linear transformations", credits: 3, department: "Mathematics" }
];
...
const timetables = [
  ...
  { id: 5, facultyId: 2, subjectId: 6, classroomId: 2, day: "Friday", startTime: "13:00", endTime: "14:30", semester: "Fall 2024" }
];
